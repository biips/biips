...
#' @param transform   boolean. Activate automatic parameters transformation
...
#' @param rs_thres,rs_type,... Additional arguments to be passed to the SMC
#'   algorithm. See \code{\link{biips_smc_samples}} for more details.
...
#'   \code{f}: \code{info$n_fail}. number of failed SMC algorithms. }
#'
#' @param max_fail integer. maximum number of failed SMC algorithms allowed.
#'   (default=0).
#' @param rw_adapt      boolean. Activate adaptation of the proposal
#'   (default=TRUE)
#'
...
#'
#' @return Members of the \code{\link{mcmcarray.list}} object are
