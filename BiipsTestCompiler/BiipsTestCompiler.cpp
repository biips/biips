...
namespace Biips
{
  ...
  void
      plotStat(Console & console,
               const String & varName,
               const String & statName,
               const StoredDataMap & benchStatMap,
               const std::map<String, std::map<IndexRange, MultiArray> > & smcStatMap,
               Types<Curve>::Array & curves,
               Bool smooth = false);

  void plotPdf(Console & console,
               const Types<String>::Array & monitoredVar,
               Bool verbose,
               Size numBins,
               Bool smooth = false);
...
BOOST_AUTO_TEST_CASE( my_test )
{
  ...
  try
  {
    ...
    generic.add_options()("help-test,h", "produces help message.")("version",
                                                                   "prints version string.")("verbose,v",
                                                                                             po::value<
                                                                                                 Size>(&verbosity)->default_value(1),
                                                                                             "verbosity level.\n"
                                                                                               "values:\n"
                                                                                               " 0: \tnone.\n"
                                                                                               " 1: \tminimal.\n"
                                                                                               " 2: \thigh.")("interactive",
                                                                                                              "asks questions to the user.\n"
                                                                                                                "applies when verbose>0.")("show-plots,s",
                                                                                                                                           po::value<
                                                                                                                                               Size>(&show_mode)->default_value(0),
                                                                                                                                           "shows plots, interrupting execution.\n"
                                                                                                                                             "applies when repeat-smc=1.\n"
                                                                                                                                             "values:\n"
                                                                                                                                             " 0: \tno plots.\n"
                                                                                                                                             " 1: \tshows final results plots.\n"
                                                                                                                                             " 2: \t1 + shows pdf histogram plots.")("num-bins",
                                                                                                                                                                                     po::value<
                                                                                                                                                                                         Size>(&num_bins)->default_value(40),
                                                                                                                                                                                     "number of bins in the histogram plots.")("step",
                                                                                                                                                                                                                               po::value<
                                                                                                                                                                                                                                   Size>(&exec_step)->default_value(3),
                                                                                                                                                                                                                               "execution step to be reached (if possible).\n"
                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                 " 3: \t2 + checks that errors are distributed according to reference SMC errors, when repeat-smc>1. checks that error is lesser than a 1-alpha quantile of the reference SMC errors, when repeat-smc=1.")("smooth",
                                                                                                                                                                                                                                                                                                                                                                                                                                           po::value<
                                                                                                                                                                                                                                                                                                                                                                                                                                               String>(&do_smooth_str)->default_value("on"),
                                                                                                                                                                                                                                                                                                                                                                                                                                           "toggle backward smoothing step.\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                             "values:\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                             " on: \tenable backward smoothing step.\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                             " off: \tdisable backward smoothing step.")("check-mode",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         po::value<
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             Size>(&check_mode)->default_value(2),
    ...
    config.add_options()("model-file",
                         po::value<String>(&model_file_name),
                         "BUGS model file name.")("data-rng-seed", po::value<
        Size>(&data_rng_seed), "data sampler rng seed. default=time().")("particles",
                                                                         po::value<
                                                                             vector<
                                                                                 Size> >(&n_particles)->default_value(vector<
                                                                             Size> (1,
                                                                                    1000)),
                                                                         "numbers of particles.")("smc-rng-seed",
                                                                                                  po::value<
                                                                                                      Size>(&smc_rng_seed),
                                                                                                  "SMC sampler rng seed. default=time().\n"
                                                                                                    "applies when repeat-smc=1.")("mutations",
                                                                                                                                  po::value<
                                                                                                                                      vector<
                                                                                                                                          String> >(&mutations)->default_value(vector<
                                                                                                                                      String> (1,
                                                                                                                                               "optimal")),
                                                                                                                                  "type of exploration used in the mutation step of the SMC algorithm.\n"
                                                                                                                                    ...
                                                                                                                                    " <other>: \tpossible model-specific mutation.")("resampling",
                                                                                                                                                                                     po::value<
                                                                                                                                                                                         String>(&resample_type)->default_value("stratified"),
                                                                                                                                                                                     "resampling method.\n"
                                                                                                                                                                                       "values:\n"
                                                                                                                                                                                       " multinomial\n"
                                                                                                                                                                                       " residual\n"
                                                                                                                                                                                       ...
                                                                                                                                                                                       " systematic")("ess-threshold",
                                                                                                                                                                                                      po::value<
                                                                                                                                                                                                          Scalar>(&ess_threshold)->default_value(0.5),
                                                                                                                                                                                                      "ESS resampling threshold.")("repeat-smc",
                                                                                                                                                                                                                                   po::value<
                                                                                                                                                                                                                                       Size>(&n_smc)->default_value(1),
                                                                                                                                                                                                                                   "number of independent SMC executions for each mutation and number of particles.")("alpha",
                                                                                                                                                                                                                                                                                                                      po::value<
                                                                                                                                                                                                                                                                                                                          Scalar>(&reject_level)->default_value(0.01),
    ...
    hidden.add_options()("cfg",
                         po::value<String>(&config_file_name)->default_value(BIIPSTEST_CONFIG_FILE_NAME),
    ...
    {
      parsed_sources.push_back(po::command_line_parser(argc, argv). options(cmdline_options).positional(pos_desc).run());
    ...
    if (vm.count("cfg"))
    {
      ...
      parsed_sources.push_back(po::parse_config_file(ifs,
                                                     config_file_options,
                                                     true));
    ...
    storeUnregistered(parsed_sources,
                      sources_names,
                      monitored_var,
                      dim_map_stored,
                      data_map_stored,
                      ...
                      errors_filter_ref_map_stored,
                      errors_smooth_ref_map_stored);
    ...
    for (Size i_n_part = 0; i_n_part < n_particles.size(); ++i_n_part)
    {
      ...
      for (Size i_mut = 0; i_mut < mutations.size(); ++i_mut)
      {
        ...
        if (!console.BuildSampler(mut == "prior", verbosity * (n_smc == 1
            || verbosity > 1)))
        ...
        for (Size i_smc = 0; i_smc < n_smc; ++i_smc)
        {
          ...
          std::map<String, std::map<IndexRange, MultiArray> > filter_mean_map =
              extractStat(console, MEAN, monitored_var, "mean", (verbosity > 0
                  && n_smc == 1), false);
          ...
          for (Size i = 0; i < monitored_var.size(); ++i)
          {
            ...
            if (!computeError(error_filter,
                              name,
                              filter_mean_map,
                              bench_filter_map_stored))
              throw RuntimeError(String("Failed to compute filtering error of variable ")
                  + name);
          }
          ...
          if (verbosity > 0 && n_smc == 1)
            cout << INDENT_STRING << "filtering error = " << error_filter
                << endl;
          ...
          if (do_smooth)
          {
            Bool verbose_run_back = verbosity > 1 || (verbosity > 0 && n_smc
                == 1);
            ...
            //----------------------------------------
            std::map<String, std::map<IndexRange, MultiArray> >
                smooth_mean_map = extractStat(console,
                                              MEAN,
                                              monitored_var,
                                              "mean",
                                              (verbosity > 0 && n_smc == 1),
            ...
            for (Size i = 0; i < monitored_var.size(); ++i)
            {
              ...
              if (verbosity > 0 && n_smc == 1)
                cout << PROMPT_STRING
                    << "Computing smoothing error of variable " << name << endl;

              if (!computeError(error_smooth,
                                name,
                                smooth_mean_map,
                                bench_smooth_map_stored))
                throw RuntimeError(String("Failed to compute smoothing error of variable ")
                    + name);
            }
        ...
        if (!log_norm_const_bench)
        {
          ...
          cerr
              << "         missing 'log-norm-const' option in section [bench]."
              << endl;
        }
        else if (n_smc == 1)
        {
        ...
        else
        {
          ...
          Scalar student_stat = (mean(norm_const_smc_acc)
              - exp(log_norm_const_bench)) / sqrt(variance(norm_const_smc_acc))
              * sqrt(Scalar(n_smc));
          boost::math::students_t student_dist(n_smc - 1);

          Scalar t_p_value = 2 * cdf(complement(student_dist,
                                                fabs(student_stat)));
        ...
        if (n_smc == 1)
        {
          ...
          if (check_filter)
          {
            ...
            errors_filter_ref_acc = acc_ref_type(quantile_probability = 1
                - reject_level);
            for (Size i = 0; i
                < errors_filter_ref_map_stored[mut][n_part].size(); ++i)
          ...
          if (check_smooth)
          {
            ...
            errors_smooth_ref_acc = acc_ref_type(quantile_probability = 1
                - reject_level);
            for (Size i = 0; i
                < errors_smooth_ref_map_stored[mut][n_part].size(); ++i)
        ...
        else if (n_smc > 1)
        {
          if (check_filter && !errors_filter_new.empty())
          {
            ...
            Scalar
                ks_filter_stat =
                    ksTwoSamplesStat(errors_filter_new.begin(),
            ...
            Scalar ks_filter_prob = ksProb(sqrt(n_err * n_err_ref / (n_err
                + n_err_ref)) * ks_filter_stat);
          ...
          if (check_smooth && !errors_smooth_new.empty())
          {
            ...
            Scalar
                ks_smooth_stat =
                    ksTwoSamplesStat(errors_smooth_new.begin(),
            ...
            Scalar ks_smooth_prob = ksProb(sqrt(n_err * n_err_ref / (n_err
                + n_err_ref)) * ks_smooth_stat);
...
namespace Biips
{
    ...
    for (Size i = 0; i < monitoredVar.size(); ++i)
    {
      ...
      if (!smooth)
      {
        if (!console.ExtractFilterStat(name, tag, stat_map[name]))
          throw RuntimeError(String("Failed to extract filtering stat of variable ")
              + name);
      }
      else
      {
        if (!console.ExtractSmoothStat(name, tag, stat_map[name]))
          throw RuntimeError(String("Failed to extract smoothing stat of variable ")
              + name);
      }
    }
                ...
                Bool smooth)
  {
    ...
    if (smcStatMap.at(varName).begin()->first.Dim().IsScalar())
    {
      ...
      std::map<IndexRange, MultiArray>::const_iterator it_smc_stat =
          smcStatMap.at(varName).begin();
      for (Size k = 0; it_smc_stat != smcStatMap.at(varName).end(); ++k, ++it_smc_stat)
      {
        curve_bench.x[k] = k;
      ...
      plot.SetTitle(String("SMC estimates vs. benchmarks of variable ")
          + varName);
    ...
    else
    {
      ...
      plot.SetTitle(String("SMC estimates vs. benchmarks of variable ")
          + varName + " (only the 2 first components)");
      plot.SetAxesLabels(varName + " (1st component)", varName
          + " (2nd component)");
    }

    for (Size i = 0; i < curves.size(); ++i)
    {
      plot.AddCurve(curves[i].x,
                    curves[i].y,
                    curves[i].legend,
                    curves[i].color,
                    curves[i].lineWidth,
                    curves[i].lineStyle,
                    curves[i].symbolWidth,
                    curves[i].symbol);
    }
               ...
               Bool smooth)
  {
    ...
    for (Size i = 0; i < monitoredVar.size(); ++i)
    {
      ...
      {
        if (!smooth)
          cout << PROMPT_STRING << "Extracting filtering Pdf of variable "
              << name << endl;
        else
          cout << PROMPT_STRING << "Extracting smoothing Pdf of variable "
              << name << endl;
      }
      ...
      if (!smooth)
      {
        if (!console.ExtractFilterPdf(name, pdf_map[name], numBins, 1.0))
          ...
          throw RuntimeError(String("Failed to extract filtering Pdf of variable ")
              + name);
      }
      else
      {
        if (!console.ExtractSmoothPdf(name, pdf_map[name], numBins, 1.0))
          throw RuntimeError(String("Failed to extract smoothing Pdf of variable ")
              + name);
      }
          ...
          pdf_map[name].begin(); it_pdf_map != pdf_map[name].end(); ++it_pdf_map)
      {
        ...
        if (!smooth)
        {
          pdf_plot.SetTitle(String("Filtering Pdf histogram of variable: ")
              + name + print(it_pdf_map->first));
        }
        else
        {
          pdf_plot.SetTitle(String("Smoothing Pdf histogram of variable: ")
              + name + print(it_pdf_map->first));
        }
  ...
  Bool computeError(Scalar & error,
                    const String & varName,
                    ...
                    const std::map<String, std::vector<MultiArray> > & benchValuesMap)
  {
    ...
    const std::map<IndexRange, MultiArray> & smc_values_map =
        smcMeanValuesMap.find(varName)->second;
    const std::vector<MultiArray> & bench_values =
        benchValuesMap.find(varName)->second;
    const std::vector<MultiArray> & bench_var_values =
        benchValuesMap.find("var." + varName)->second;
    ...
    for (Size k = 0; it_smc_values != smc_values_map.end(); ++k, ++it_smc_values)
    {
      ...
      Vector diff_vec(dim, it_smc_values->second.Values()
