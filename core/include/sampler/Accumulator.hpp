...
namespace Biips
{
  ...
  struct Tags
  {
    ...
    typedef acc::droppable<acc::tag::weighted_p_square_cumulative_distribution>
        Cdf;
  };
  ...
  public:
    ...
    typedef acc::accumulator_set<Scalar, acc::features<Tags::Count, Tags::Sum,
        Tags::SumOfWeights, Tags::Mean, Tags::Variance, Tags::Skewness,
        Tags::Kurtosis, Tags::Moment2, Tags::Moment3, Tags::Moment4,
        Tags::Moment5, Tags::Min, Tags::Max, Tags::Pdf, Tags::Quantiles,
        Tags::Cdf>, Scalar> AccType;
  ...
  public:
    ...
    void SetPdfParam(Size cacheSize, Size numBins)
    {
      pdfCacheSize_ = cacheSize;
      pdfNumBins_ = numBins;
    }

    template<typename InputIterator>
    void SetQuantileProbs(InputIterator first, InputIterator last)
    {
      quantileProbs_.assign(first, last);
    }
    void ClearQuantileProbs()
    {
      quantileProbs_.clear();
    }
    void AddQuantileProb(Scalar prob)
    {
      quantileProbs_.push_back(prob);
    }
    void RemoveQuantileProb(Scalar prob)
    {
      quantileProbs_.remove(prob);
    }

    void SetCdfParam(Size numCells)
    {
      cdfNumCells_ = numCells;
    }
    ...
    ScalarHistogram Pdf() const
    {
      return ScalarHistogram(acc::weighted_density(acc_));
    } // TODO throw exception
    Scalar Quantile(Size i) const
    {
      return acc::weighted_extended_p_square(acc_)[i];
    } // TODO throw exception
    ScalarHistogram Cdf() const
    {
      return ScalarHistogram(acc::weighted_p_square_cumulative_distribution(acc_));
    } // TODO throw exception
  };
  ...
  public:
    ...
    typedef acc::accumulator_set<Scalar, acc::features<Tags::Count,
        Tags::SumOfWeights, Tags::Min, Tags::Max>, Scalar> AccType;
  ...
  public:
    ...
    typedef Types<SelfType>::Ptr Ptr;
    typedef acc::accumulator_set<StorageType, acc::features<Tags::Count,
        Tags::Sum, Tags::SumOfWeights, Tags::Mean, Tags::Variance,
        Tags::Skewness, Tags::Kurtosis, Tags::Moment2, Tags::Moment3,
        Tags::Moment4, Tags::Moment5>, Scalar> AccType;
  ...
  template<Size Order>
  MultiArray ElementAccumulator::Moment() const
  {
