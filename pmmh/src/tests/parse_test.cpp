...
// unlegal variable name (beginning with number)
...
// unlegal variable name (brackets contain nothing)
...
// unlegal variable name (one domaine is inconsistent)
...
// unlegal variable name (two brackets domain)
...
// unlegal variable name (bounded range with lacking bound)
