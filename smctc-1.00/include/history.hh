...
namespace smc {
  ...
  public:
    ...
    virtual ~historyelement(); /* Modified on 19/03/2010 by Adrien Todeschini : added virtual */
    ...
    {
      if(ulCount)
//	return this->pNext << (--ulCount); /* Modified on 16/03/2010 by Adrien Todeschini */
        return this->pNext >> (--ulCount); /* Modified on 16/03/2010 by Adrien Todeschini  : error fixed */
      else
	return *this;
    }
  ...
  historyelement<Particle>::historyelement() : flags(0) /* Modified on 23/03/2010 by Adrien Todeschini : added flags(0) initializator */
  {
    number = 0;
    value = NULL;
    nAccepted = 0;
  ...
  template <class Particle> class history
    {
    //private: /* Modified on 19/03/2010 by Adrien Todeschini*/
    protected: /* Modified on 19/03/2010 by Adrien Todeschini : protected instead of private */
