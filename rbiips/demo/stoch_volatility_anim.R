...
palette("default")
mycols1 <- adjustcolor(palette(), alpha.f = 0.5)
mycols2 <- adjustcolor(palette(), alpha.f = 0.4)
mycols3 <- adjustcolor(palette(), alpha.f = 0.1)
...
for (t in 1:t.max) {
  ...
  plot(1:t-1, x.summ$f$Mean[1:t], type='o', lwd=lwd, lty=1, col=4, pch=18, bty='n',
