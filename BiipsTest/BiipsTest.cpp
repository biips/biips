...
BOOST_AUTO_TEST_CASE( my_test )
{
  ...
  try
  {
    ...
    storeUnregistered(parsed_sources, sources_names, model_map, dim_map, data_map, bench_filter_map, bench_smooth_map, errors_filter_ref_map, errors_smooth_ref_map);
