...
namespace Biips
{
  ...
  public:
    ...
    void AddCurve(const DataType::Array & x, const DataType::Array & y, String name, const QColor & color = Qt::blue, uint width = 1, Qt::PenStyle style = Qt::SolidLine, uint symbolSize = 5, QwtSymbol::Style symbol = QwtSymbol::NoSymbol);
    ...
    void AddHistogram(const DataType::Array & x, const DataType::Array & y, String name, const QColor & color = Qt::blue);
