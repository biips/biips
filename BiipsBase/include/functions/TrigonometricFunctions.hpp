...
namespace Biips
{
  ...
  protected:
    ArcSin() : BaseType("arcsin") {};

    virtual Bool checkParamValues(const MultiArray::Array & paramValues) const;

  public:
    virtual String Alias() const { return "asin"; }
    static Function::Ptr Instance() { static Function::Ptr p_instance(new SelfType()); return p_instance; };
  };
  ...
  protected:
    ArcTan() : BaseType("arctan") {};

    virtual Bool checkParamValues(const MultiArray::Array & paramValues) const { return true; };

  public:
    virtual String Alias() const { return "atan"; }
    static Function::Ptr Instance() { static Function::Ptr p_instance(new SelfType()); return p_instance; };
  };
  ...
  protected:
    ArcCosh() : BaseType("arccosh") {};

    virtual Bool checkParamValues(const MultiArray::Array & paramValues) const;

  public:
    virtual String Alias() const { return "acosh"; }
    static Function::Ptr Instance() { static Function::Ptr p_instance(new SelfType()); return p_instance; };
  };
  ...
  protected:
    ArcSinh() : BaseType("arcsinh") {};

    virtual Bool checkParamValues(const MultiArray::Array & paramValues) const { return true; };

  public:
    virtual String Alias() const { return "asinh"; }
    static Function::Ptr Instance() { static Function::Ptr p_instance(new SelfType()); return p_instance; };
  };
  ...
  protected:
    ArcTanh() : BaseType("arctanh") {};

    virtual Bool checkParamValues(const MultiArray::Array & paramValues) const;

  public:
    virtual String Alias() const { return "atanh"; }
    static Function::Ptr Instance() { static Function::Ptr p_instance(new SelfType()); return p_instance; };
  };
}
