...
\section{Interface Matlab au logiciel \biips{}}
  ...
  \hline
   \texttt{biips\_add\_function} & add a external function \\
  ...
  \end{figure}
   ...
   let assume that the user of \biips{} wrote his model in \verb!model.bug! file , the matbiips session
...
\end{lstlisting}
   ...
   Concerning functions previously used, we can isolate severals general principles
     \begin{itemize}
       ...
       , so you have to save it after a \texttt{biips\_model} call.
